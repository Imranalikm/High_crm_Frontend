    ...
    <div ref={ref} className={`auth-panel ${isActive ? 'visible' : 'slide-out-left'}${shake ? ' auth-shake' : ''}`}>
      ...
      <div style={{ marginTop: 10, display: 'none' }}>
        ...
        <div style={{ display: 'flex', gap: 8, justifyContent: 'center', marginTop: 8 }}>
          ...
          >
            <svg width="11" height="11" viewBox="0 0 24 24" fill="currentColor"><path d="M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2 .77-3.27.82-1.31.05-2.3-1.32-3.14-2.53C4.25 17 2.94 12.45 4.7 9.39c.87-1.52 2.43-2.48 4.12-2.51 1.28-.02 2.5.87 3.29.87.78 0 2.26-1.07(Apple is commented out) ... " fill="#fff" /></svg>
            Apple
          </button>
          <button
            type="button"
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16, position: 'relative', zIndex: 2 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
            <div style={{
              ...
              <img src="/LOGO (1).png" alt="Logo" style={{ width: '100%', height: '100%', objectFit: 'contain' }} />
            </div>
            <div>
