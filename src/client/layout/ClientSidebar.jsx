                  ...
                  <button
                    ...
                    className={`
                      ...
                      ${isSub
                        ...
                        : 'text-text-muted/60 hover:bg-text/[0.04] hover:text-text/80'
                      }
                    `}
                  >
                    ...
                    <span
                      className={`
                        ...
                        ${isSub ? 'bg-primary/70' : 'bg-border/30 group-hover/sub:bg-border/50'}
                      `}
                    />
                    {/* Active sub dot */}
                    {isSub && (
  ...
  const groupedItems = useMemo(
    () =>
      clientNavigationSections.map((section) => ({
        ...section,
        items: clientNavigation.filter((item) => item.navSection === section.id && !item.hidden),
      })),
    [],
  );
